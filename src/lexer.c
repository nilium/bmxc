...
static token_single_t const token_singles[] = {
	...
	{ .kind = TOK_FIELD_KW, .case_sensitive = false, .matches = "field" },
...
static token_pair_t const token_pairs[] = {
	{ .left = TOK_END_KW, .right = TOK_REM_KW, .kind = TOK_ENDREM_KW, .range = 1, .rewind = false },
	
	{ .left = TOK_END_KW, .right = TOK_METHOD_KW, .kind = TOK_ENDMETHOD_KW, .range = 1, .rewind = false },
	{ .left = TOK_END_KW, .right = TOK_FUNCTION_KW, .kind = TOK_ENDFUNCTION_KW, .range = 1, .rewind = false },
	{ .left = TOK_END_KW, .right = TOK_TYPE_KW, .kind = TOK_ENDTYPE_KW, .range = 1, .rewind = false },
	
	{ .left = TOK_END_KW, .right = TOK_EXTERN_KW, .kind = TOK_ENDEXTERN_KW, .range = 1, .rewind = false },
	
	{ .left = TOK_END_KW, .right = TOK_IF_KW, .kind = TOK_ENDIF_KW, .range = 1, .rewind = false },
	{ .left = TOK_END_KW, .right = TOK_SELECT_KW, .kind = TOK_ENDSELECT_KW, .range = 1, .rewind = false },
	{ .left = TOK_END_KW, .right = TOK_WHILE_KW, .kind = TOK_ENDWHILE_KW, .range = 1, .rewind = false },
	
#ifdef BMAX_USE_ADDITIONS
	
	{ .left = TOK_END_KW, .right = TOK_PROTOCOL_KW, .kind = TOK_ENDPROTOCOL_KW, .range = 1, .rewind = false },
	
#endif
	
	{ .left = TOK_COLON, .right = TOK_PLUS, .kind = TOK_ASSIGN_ADD, .range = 0, .rewind = false },
	{ .left = TOK_COLON, .right = TOK_MINUS, .kind = TOK_ASSIGN_SUBTRACT, .range = 0, .rewind = false },
	{ .left = TOK_COLON, .right = TOK_SLASH, .kind = TOK_ASSIGN_DIVIDE, .range = 0, .rewind = false },
	{ .left = TOK_COLON, .right = TOK_ASTERISK, .kind = TOK_ASSIGN_MULTIPLY, .range = 0, .rewind = false },
	{ .left = TOK_COLON, .right = TOK_CARET, .kind = TOK_ASSIGN_POWER, .range = 0, .rewind = false },
	
	{ .left = TOK_COLON, .right = TOK_SHL_KW, .kind = TOK_ASSIGN_SHL, .range = 0, .rewind = false },
	{ .left = TOK_COLON, .right = TOK_SHR_KW, .kind = TOK_ASSIGN_SHR, .range = 0, .rewind = false },
	{ .left = TOK_COLON, .right = TOK_SAR_KW, .kind = TOK_ASSIGN_SAR, .range = 0, .rewind = false },
	{ .left = TOK_COLON, .right = TOK_MOD_KW, .kind = TOK_ASSIGN_MOD, .range = 0, .rewind = false },
	
	{ .left = TOK_COLON, .right = TOK_TILDE, .kind = TOK_ASSIGN_XOR, .range = 0, .rewind = false },
	{ .left = TOK_COLON, .right = TOK_AMPERSAND, .kind = TOK_ASSIGN_AND, .range = 0, .rewind = false },
	{ .left = TOK_COLON, .right = TOK_PIPE, .kind = TOK_ASSIGN_OR, .range = 0, .rewind = false },
	
#ifdef BMAX_USE_ADDITIONS
	
	{ .left = TOK_COLON, .right = TOK_EQUALS, .kind = TOK_ASSIGN_AUTO, .range = 0, .rewind = false },
	{ .left = TOK_MINUS, .right = TOK_MINUS, .kind = TOK_DOUBLEMINUS, .range = 0, .rewind = false },
	{ .left = TOK_PLUS, .right = TOK_PLUS, .kind = TOK_DOUBLEPLUS, .range = 0, .rewind = false },

	{ .left = TOK_LESSTHAN, .right = TOK_LESSTHAN, .kind = TOK_LSHIFT, .range = 0, .rewind = true },
	{ .left = TOK_GREATERTHAN, .right = TOK_GREATERTHAN, .kind = TOK_RSHIFT, .range = 0, .rewind = true },

	{ .left = TOK_COLON, .right = TOK_LSHIFT, .kind = TOK_ASSIGN_LSHIFT, .range = 0, .rewind = false },
	{ .left = TOK_COLON, .right = TOK_RSHIFT, .kind = TOK_ASSIGN_RSHIFT, .range = 0, .rewind = false },
	
#endif
	
	//	{ .left = TOK_MINUS, .right = TOK_NUMBER_LIT, .kind = TOK_NUMBER_LIT, .range = 0, .rewind = false },
	{ .left = TOK_INVALID, .right = TOK_INVALID, .kind = TOK_INVALID, .range = -1, .rewind = false },
};
	...
	while (lexer->tokens[tok_index].kind != TOK_EOF) {
		...
		while (pair_iter->left != TOK_INVALID && !merged) {
			if (pair_iter->left == left.kind && pair_iter->right == right.kind &&
				...
				merged = true;
				rewind = rewind || (pair_iter->rewind);
			}
			++pair_iter;
		}
...
token_t *lexer_copy_tokens(lexer_t *lexer, size_t *num_tokens) {
	...
	size_t num = lexer->current.token;
